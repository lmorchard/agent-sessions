...
**Title:** gate-test omits test_assertion_lint.py, so the detector's own tests never run

Captured from the issue body (marker line stripped) at session start, 2026-08-01.
